    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', ckeditor.fields.RichTextField(blank=True, verbose_name='Biografía')),
                ('edad', models.IntegerField(default=0)),
                ('foto', models.ImageField(blank=True, upload_to='media')),
                ('linkedin', models.URLField(blank=True, verbose_name='Perfil linkedin')),
                ('departamento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.departamento', verbose_name='Departamento')),
